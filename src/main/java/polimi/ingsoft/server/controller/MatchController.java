...
public class MatchController implements Serializable {
    ...
    /**
     * Returns the initial setting of a player by their nickname.
     *
     * @param nickname the nickname of the player
     * @return an Optional containing the player's initial setting if found, otherwise an empty Optional
     */
    ...
    /**
     * Returns the player by their nickname.
     *
     * @param nickname the nickname of the player
