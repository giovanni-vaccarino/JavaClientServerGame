...
public enum BoardArgument implements Arguments {
    ...
    LEFT("left", new Coordinates(-2, -2), List.of(new Coordinates[]{
            new Coordinates(-2, 0),
            new Coordinates(-3, 1),
            new Coordinates(-3, -1)
    })),
    ...
    DOWNRIGHT("downright", new Coordinates(2, -2), List.of(new Coordinates[]{
            new Coordinates(2, -2),
            new Coordinates(3, 1),
            new Coordinates(3, -3),
            new Coordinates(1, -3)
    })),
    DOWNLEFT("downleft", new Coordinates(-2, -2), List.of(new Coordinates[]{
            new Coordinates(-2, -2),
            new Coordinates(-1, -3),
            new Coordinates(-3, -3),
            new Coordinates(-3, -1)
